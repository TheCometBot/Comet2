...
def register(bot: commands.Bot, db=None, ):
    ...
    async def kick(ctx, member: discord.Member, reason: str = None):
        ...
        await ctx.respond(embed=make_embed("✅ Mitglied gekickt", f"{member.mention} wurde gekickt.\nGrund: {reason or 'Keiner'}", discord.Color.green()))
    ...
    async def ban(ctx, member: discord.Member, reason: str = None):
        await ctx.defer()
        if ctx.guild.me.top_role <= member.top_role:
            await ctx.respond(embed=make_embed("❌ Fehler", "Ich kann diesen Nutzer nicht bannen (höhere Rolle).", discord.Color.red()))
            return
        await member.ban(reason=reason)
        await ctx.respond(embed=make_embed("✅ Mitglied gebannt", f"{member.mention} wurde gebannt.\nGrund: {reason or 'Keiner'}", discord.Color.green()))
    ...
    async def mute(ctx, member: discord.Member, reason: str = None):
        ...
        await ctx.respond(embed=make_embed("✅ Mitglied gemutet", f"{member.mention} wurde gemutet.\nGrund: {reason or 'Keiner'}", discord.Color.orange()))
    ...
    async def unmute(ctx, member: discord.Member):
        ...
        if muted_role in member.roles:
            ...
            await ctx.respond(embed=make_embed("✅ Mitglied entmutet", f"{member.mention} wurde entmutet.", discord.Color.green()))
        else:
            await ctx.respond(embed=make_embed("ℹ️ Info", f"{member.mention} ist nicht gemutet.", discord.Color.blue()))
    ...
    async def warn(ctx, member: discord.Member, reason: str = None):
        await ctx.defer()
        if member.bot:
            await ctx.respond(embed=make_embed("❌ Fehler", "Du kannst Bots nicht verwarnen.", discord.Color.red()))
            return
        try:
        ...
        await ctx.respond(embed=make_embed("⚠️ Verwarnung", f"{member.mention} wurde verwarnt.\nGrund: {reason or 'Keiner'}", discord.Color.orange()))
    ...
    async def clearwarnings(ctx, member: discord.Member):
        ...
        await ctx.respond(embed=make_embed("✅ Verwarnungen gelöscht", f"Alle Verwarnungen von {member.mention} wurden gelöscht.", discord.Color.green()))
